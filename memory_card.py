...
questions_list.append(Question('cuando se acabo la Gran guerra', '1918', '1910', '1919', '1920'))
questions_list.append(Question('what is your desired salary', '0', '45$/h', '30$/h', '100$/h'))
...
def next_question():
    ...
    window.total += 1
    print('total stats', window.total)
